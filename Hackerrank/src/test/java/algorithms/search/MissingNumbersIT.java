 ...
 * @author marckoch
 */
public class MissingNumbersIT extends HackerrankFileBasedTest {
    ...
    public static Collection<Object[]> getTestFiles() throws IOException, URISyntaxException {
        return getAllTestFiles(MissingNumbersIT.class);
        //return getSingleTestFile(MissingNumbersIT.class, "30");
    }

    public MissingNumbersIT(String inputFile, String outputFile) {
