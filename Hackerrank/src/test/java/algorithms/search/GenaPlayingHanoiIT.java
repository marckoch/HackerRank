 ...
 * @author marckoch
 */
public class GenaPlayingHanoiIT extends HackerrankFileBasedTest {
    ...
    public static Collection<Object[]> getTestFiles() throws IOException, URISyntaxException {
        return getAllTestFiles(GenaPlayingHanoiIT.class);
        //return getSingleTestFile(GenaPlayingHanoiIT.class, "05");
    }

    public GenaPlayingHanoiIT(String inputFile, String outputFile) {
    ...
    public void testFile() throws Exception {
        ...
        //GenaPlayingHanoi.mainFast(null);
