 ...
 * @author marckoch
 */
public class CutTheTreeIT extends HackerrankFileBasedTest {
    ...
    public static Collection<Object[]> getTestFiles() throws IOException, URISyntaxException {
        return getAllTestFiles(CutTheTreeIT.class);
        //return getSingleTestFile(CutTheTreeIT.class, "02");
    }

    public CutTheTreeIT(String inputFile, String outputFile) {
