 ...
 * @author marckoch
 */
public class BigSortingIT extends HackerrankFileBasedTest {
    ...
    public static Collection<Object[]> getTestFiles() throws IOException, URISyntaxException {
        return getAllTestFiles(BigSortingIT.class);
        //return getSingleTestFile(BigSortingIT.class, "30");
    }

    public BigSortingIT(String inputFile, String outputFile) {
