...
public class DeterminingDNAHealthUwi {
    ...
    public static class TrieByLink {
        ...
        public Node[] toArray() {
            ...
            for (int i = 0; i < gen; i++) {
                Node cur = ret[i];
                if (cur.next != null) {
                    ret[cur.next.id] = cur.next;
                }
                if (cur.firstChild != null) {
                    ret[cur.firstChild.id] = cur.firstChild;
                }
            }
            return ret;
        }
    ...
    public static void main(String[] args) throws Exception {
        new DeterminingDNAHealthUwi().run();
    }
